                    ...
                    return (
                        <SidebarMenuItem key={item.title}>
                            <SidebarMenuButton
                                ...
                                tooltip={item.title}
                                isActive={active}
                                className={`h-12 rounded-2xl px-4 transition-all duration-200 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0 ${
                                    active
                            ...
                            >
                                <Link href={item.href}>
                                    {item.icon && (
                                        <item.icon
                                            className={`size-5 shrink-0 ${active ? 'text-red-600' : 'text-[#1b1b18] dark:text-zinc-400'}`}
                                        />
                                    )}
                                            ...
                                            <SidebarMenuSubButton
                                                ...
                                                className={`h-10 rounded-xl px-4 transition-all duration-200 ${
                                                    subActive
                                                        ...
                                                        : 'text-[#1b1b18]/70 hover:bg-red-600/5 hover:text-red-600 dark:text-zinc-400'
                                                }`}
                                            >
                    ...
                    <SidebarMenuItem key={item.title}>
                        ...
                        >
                            <Link href={item.href}>
                                {item.icon && (
                                    <item.icon
                                        className={`size-5 shrink-0 ${active ? 'text-white' : 'text-[#1b1b18] dark:text-zinc-400'}`}
                                    />
                                )}
                                <span className="font-bold tracking-tight group-data-[collapsible=icon]:hidden">
                                    {item.title}
