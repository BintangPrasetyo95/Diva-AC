            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-end bg-transparent px-6 pb-10 text-center sm:pb-10">
                ...
                >
                    <div className="flex flex-col items-center gap-2 sm:items-center">
                        ...
                        <div className="h-8 w-[1px] bg-gradient-to-b from-[#1b1b18]/40 to-transparent dark:from-white/40 sm:h-12" />
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="rounded-[2rem] border border-white/20 bg-white/5 p-8 backdrop-blur-md dark:border-white/5 dark:bg-black/5 max-w-3xl"
                >
