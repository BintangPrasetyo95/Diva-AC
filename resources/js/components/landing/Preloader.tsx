            ...
            {show && (
                ...
                >
                    <div className="relative flex w-full max-w-xs flex-col items-center px-6">
                        ...
                        >
                            <div className="relative z-10 rounded-full border border-white/10 bg-white/5 p-4 shadow-2xl backdrop-blur-sm">
                        ...
                        >
                            <h1 className="text-3xl leading-none font-black tracking-tighter text-[#1b1b18] uppercase dark:text-white">
                                Diva <span className="text-red-600">AC</span>
                            </h1>
                            <span className="mt-2 text-[10px] font-bold tracking-[0.4em] text-[#1b1b18]/40 uppercase dark:text-white/40">
                                Premium Care
                            </span>
                        </m.div>
                        ...
                        <div className="w-full">
                            ...
                            <div className="mt-4 flex items-center justify-between">
                                <m.span
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    className="text-[10px] font-bold tracking-[0.2em] text-red-600 uppercase"
                                >
                                    {progress < 100
                                        ? 'Loading Assets'
                                        : 'Synchronized'}
                                ...
                                <m.span
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    className="font-mono text-[10px] font-bold text-[#1b1b18]/40 dark:text-white/40"
                                >
                                    {Math.round(progress)}%
                                </m.span>
                            </div>
