...
export default function Footer({ settings }: { settings: any }) {
    ...
    const instagramLink =
        settings?.instagram_link || 'https://www.instagram.com/diva_ac50/';
    const facebookLink =
        settings?.facebook_link || 'https://www.facebook.com/DivaAc/';
    const whatsappNumber = settings?.whatsapp || '628117998851';

    return (
        <footer className="bg-white px-6 py-12 dark:bg-[#0a0a0a]">
            <div className="mx-auto max-w-6xl">
                <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                    ...
                    <div className="flex gap-4">
                        <a
                            ...
                            className="flex size-10 items-center justify-center rounded-full bg-[#1b1b18]/5 text-[#1b1b18] transition-all hover:bg-pink-600 hover:text-white dark:bg-white/5 dark:text-white dark:hover:bg-pink-600"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex size-10 items-center justify-center rounded-full bg-[#1b1b18]/5 text-[#1b1b18] transition-all hover:bg-blue-600 hover:text-white dark:bg-white/5 dark:text-white dark:hover:bg-blue-600"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex size-10 items-center justify-center rounded-full bg-[#1b1b18]/5 text-[#1b1b18] transition-all hover:bg-green-500 hover:text-white dark:bg-white/5 dark:text-white dark:hover:bg-green-500"
                        >
                            <svg
                ...
                <div className="mt-12 border-t border-[#1b1b18]/5 pt-8 text-center text-xs text-[#1b1b18]/40 dark:border-white/5 dark:text-white/40">
                    <p>
                        © {new Date().getFullYear()} {workshopName}.{' '}
                        {t('footer_all_rights')}
                    </p>
                    <div className="mt-4 flex flex-col items-center gap-1 opacity-50">
                        <p className="mb-2 text-[10px] tracking-[0.2em] uppercase">
                        ...
                        <p className="mt-4">
                            3D Model:{' '}
                            <a
                                href="https://sketchfab.com/3d-models/free-ai-based-conceptcar-049-public-domain-cc0-72547082a35946878d3f59101ab583fa"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="transition-colors hover:text-red-600"
                            >
                                FREE Concept Car 049 by Unity Fan
                            </a>
                        </p>
                    </div>
                </div>
