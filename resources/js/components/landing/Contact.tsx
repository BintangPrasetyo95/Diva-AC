...
export default function Contact({ settings }: { settings: any }) {
    ...
    const address =
        settings?.address || 'Jl. Brigjend Katamso, Lampung Tengah, Indonesia';
    const mapsLink =
        settings?.maps_link || 'https://maps.app.goo.gl/U7B13w6BFdYH7e7e8';

    // Format hours
    const hours = settings?.opening_hours || {};
    const monSat = hours['Monday']
        ...
        <section id="contact" className="px-6 py-24">
            <div className="mx-auto max-w-6xl">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-0">
                    <div>
                        <h2 className="mb-8 text-3xl font-bold tracking-tight text-[#1b1b18] uppercase sm:text-4xl dark:text-white">
                            {t('contact_title')}
                        </h2>
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-4">
                                <a
                                    className="flex size-12 shrink-0 cursor-pointer items-center justify-center rounded-xl bg-red-600 text-white shadow-[0_0_15px_rgba(220,38,38,0.2)] transition-colors hover:bg-white hover:text-red-600"
                                    href={mapsLink}
                                    target="_blank"
                                >
                                ...
                                <div>
                                    ...
                                    <p className="text-[#1b1b18]/60 dark:text-white/60">
                                        {address}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="relative overflow-hidden rounded-3xl border border-[#1b1b18]/5 bg-gray-100 dark:border-white/5 dark:bg-zinc-900">
                        <iframe
                            ...
                            className="grayscale dark:opacity-80 dark:invert"
                        />
                    </div>
                </div>
            </div>
