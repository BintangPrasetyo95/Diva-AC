...
export const translations: Translations = {
    ...
    placeholder_gallery: { id: 'Contoh: Tampak Depan Bengkel', en: 'e.g. Workshop Front View' },
    ...
    // Features & Benefits
    f_ac_1: {
        id: 'Diagnostik Sistem Menyeluruh',
        en: 'Full System Diagnostics',
    },
    ...
    b_ac_1: {
        id: 'Performa Pendinginan Optimal',
        en: 'Optimal Cooling Performance',
    },
    ...
    f_sp_2: {
        id: 'Kondensor Berkualitas Tinggi',
        en: 'High-Quality Condensers',
    },
    ...
    f_fr_1: {
        id: 'Refrigeran Kemurnian Tinggi',
        en: 'High-Purity Refrigerant',
    },
    ...
    f_dg_3: {
        id: 'Uji Kontinuitas Elektrikal',
        en: 'Electrical Continuity Test',
    },
    ...
    // Description Section
    desc_title: {
        id: 'Kenyamanan perjalanan maksimal dengan layanan ahli berbasis pengalaman bertahun-tahun untuk memastikan sistem pendingin kendaraan Anda tetap di performa puncak.',
        en: "Maximum driving comfort powered by years of experience and expert services to keep your vehicle's cooling system at peak performance.",
    },
    desc_p1: {
    ...
    dash_confirm_delete: {
        id: 'Apakah Anda yakin ingin menghapus ini?',
    ...
    order_confirmed_desc: {
        id: 'Konfirmasi pembelian berhasil, data sudah dikirim ke admin. Apakah Anda ingin memberi tahu admin melalui WhatsApp?',
        en: 'Order confirmed successfully, your data has been sent to the admin. Would you like to notify the admin on WhatsApp?',
    },
    ...
    sell_page_subtitle: {
        id: 'Kelola transaksi dan penjualan sparepart.',
        en: 'Manage sparepart sales and transactions.',
    },
    ...
    sell_no_orders: {
        id: 'Tidak ada pesanan sparepart.',
        en: 'No sparepart orders found.',
    },
    sell_view_title: { id: 'Detail Pesanan', en: 'Order Details' },
    sell_view_desc: {
        id: 'Lihat detail lengkap pesanan sparepart ini.',
        en: 'Review the full details of this sparepart order.',
    },
    ...
    sell_edit_desc: {
        id: 'Perbarui detail pengiriman untuk pesanan ini.',
        en: 'Update the delivery details for this order.',
    },
    sell_name_label: { id: 'Nama', en: 'Name' },
    sell_save_changes: { id: 'Simpan Perubahan', en: 'Save Changes' },
    sell_verify_confirm: {
        id: 'Yakin ingin memverifikasi pesanan ini? Stok sparepart akan dikurangi.',
        en: 'Are you sure you want to verify this order? This will deduct the sparepart stock.',
    },
    sell_cancel_confirm: {
        id: 'Yakin ingin membatalkan pesanan ini?',
    ...
    'Cars': { id: 'Mobil', en: 'Cars' },
    'Laporan Pendapatan': { id: 'Laporan Pendapatan', en: 'Income Report' },
    'Inventory': { id: 'Inventaris', en: 'Inventory' },
    'Akun Saya': { id: 'Akun Saya', en: 'My Account' },
    'Services': { id: 'Layanan', en: 'Services' },
    'Workshop Identity': { id: 'Identitas Bengkel', en: 'Workshop Identity' },
    ...
    // Car Form Modals Translations
    dash_create_new_car: { id: 'Tambah Mobil Baru', en: 'Create New Car' },
    dash_create_new_car_sub: { id: 'Tambahkan mobil baru ke database. Anda dapat menghubungkannya dengan pelanggan lama atau membuat pelanggan baru.', en: 'Add a new car to the database. You can assign it to an existing customer or create a new one.' },
    dash_existing_customer: { id: 'Pelanggan Lama', en: 'Existing Customer' },
    dash_new_customer: { id: 'Pelanggan Baru', en: 'New Customer' },
    dash_select_customer: { id: 'Pilih Pelanggan', en: 'Select Customer' },
    dash_select_existing_customer: { id: 'Pilih pelanggan yang sudah ada', en: 'Select an existing customer' },
    dash_customer_name: { id: 'Nama Pelanggan', en: 'Customer Name' },
    dash_phone_number: { id: 'Nomor Telepon', en: 'Phone Number' },
    dash_email: { id: 'Email', en: 'Email' },
    dash_gender: { id: 'Jenis Kelamin', en: 'Gender' },
    dash_male: { id: 'Laki-laki (Male)', en: 'Male (Laki-laki)' },
    dash_female: { id: 'Perempuan (Female)', en: 'Female (Perempuan)' },
    dash_address: { id: 'Alamat', en: 'Address' },
    dash_car_details: { id: 'Detail Mobil', en: 'Car Details' },
    dash_brand: { id: 'Merk', en: 'Brand (Merk)' },
    dash_model: { id: 'Model', en: 'Model' },
    dash_license_plate: { id: 'No Polisi', en: 'License Plate (No Polisi)' },
    dash_year: { id: 'Tahun', en: 'Year (Tahun)' },
    dash_color: { id: 'Warna', en: 'Color (Warna)' },
    dash_saving: { id: 'Menyimpan...', en: 'Saving...' },
    dash_save_car: { id: 'Simpan Mobil', en: 'Save Car' },
    dash_edit_car: { id: 'Edit Mobil', en: 'Edit Car' },
    dash_edit_car_sub: { id: 'Perbarui detail mobil atau ubah pemiliknya.', en: 'Update car details or change the owner.' },
    dash_update_car: { id: 'Perbarui Mobil', en: 'Update Car' },
    dash_select_owner: { id: 'Pilih Pemilik', en: 'Select Owner' },
    dash_car_created: { id: 'Mobil berhasil ditambahkan', en: 'Car successfully created' },
    dash_car_updated: { id: 'Mobil berhasil diperbarui', en: 'Car successfully updated' },
    dash_col_vehicle_info: { id: 'Info Kendaraan', en: 'Vehicle Info' },
